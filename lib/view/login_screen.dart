...
import 'package:login_or_signup_exam/view/home_screen.dart';
import 'package:login_or_signup_exam/view/registration_screen.dart';
          ...
          children: [
            Column(
              ...
              children: [
                ...
                InkWell(
                  onTap: () async {
                    if (_formKey.currentState!.validate()) { final SharedPreferences prefs =
