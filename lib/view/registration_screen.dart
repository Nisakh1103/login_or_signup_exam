              ...
              children: [
                ...
                InkWell(
                  ...
                  child: Container(
                    ...
                    child: Padding(
                      padding: const EdgeInsets.all(15),
                      child: Center(child: Text("Sign up",style: TextStyle(fontSize: 17,fontWeight: FontWeight.bold,color: Colors.white),)),
                    ),
                  ),
                )
              ],
            ...
            Row(
              ...
              children: [
                ...
                InkWell(
                  ...
                  child: Text("Sign in",style: TextStyle(fontSize: 17,fontWeight: FontWeight.w500,color: Colors.blue.shade500),))
              ],
            ),
          ],
        ),
